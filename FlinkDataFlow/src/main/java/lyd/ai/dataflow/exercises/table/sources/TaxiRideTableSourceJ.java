 ...
 *
 */
public class TaxiRideTableSourceJ implements StreamTableSource<Row>, DefinedRowtimeAttributes {
	 ...
	 */
	public TaxiRideTableSourceJ(String dataFilePath) {
	 ...
	 */
	public TaxiRideTableSourceJ(String dataFilePath, int servingSpeedFactor) {
	 ...
	 * @param servingSpeedFactor The serving speed factor by which the logical serving time is adjusted.
	 */
	public TaxiRideTableSourceJ(String dataFilePath, int maxEventDelaySecs, int servingSpeedFactor) {
